    ...
    <div class="table-responsive">
        <table class="table table-striped" id="ip-list-table">
            ...
            <tbody id="ip-list-body">
                ...
                <tr id="ip-<?= htmlspecialchars($ip['id']) ?>" class="ping-time-row" data-ping-time="<?= $ip['last_ping_time'] ?>">
                    ...
                    <td data-label="Son Ping">
                        <i class="ping-status-dot"></i> <!-- Dot eklendi -->
                        <span><i class="bi bi-clock-history"></i> <?= htmlspecialchars($ip['last_ping_time']) ?></span>
                    </td>
                    <td data-label="Durum">
